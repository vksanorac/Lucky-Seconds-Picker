      ...
      body: Padding(
          ...
          child: BlocBuilder<HomeScreenCubit, HomeScreenState>(
              ...
              builder: (context, state) {
                if (state.homeScreenStateProgress ==
                        HomeScreenStateProgress.Loaded ||
                    state.homeScreenStateProgress ==
                        HomeScreenStateProgress.Success) {
                  return ListView(
                    children: [
                      HomeCard(
                          height: height * 0.5,
                          ...
                          child: Center(
                              child: state.homeScreenStateProgress ==
                                      HomeScreenStateProgress.Success
                                  ? SuccessWidget(
                                      child: Column(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        Text(
                                            "${state.message} ${state.randomNumber}",
                                            style: TextStyle(
                                                color: Colors.green,
